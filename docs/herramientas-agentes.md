...
1. **Crear el Cliente**
   ...
   *Tip: Si usas una plantilla, el sitio nace publicado. Si lo duplicas, nace despublicado.*
...
5. **Añadir o Editar Páginas y Bloques**
   ...
   *Tip: Si necesitas imágenes reales que no estén pre-cargadas en el kit, usa `upload_media` para subir imágenes desde tu entorno y luego inserta el `key` retornado en los `props` del bloque.*
